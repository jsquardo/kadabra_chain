...
class Block:
  ...
  def mine_block(last_block, data):
    ...
    # Mines a block based on the given last_block and data, until
    # a block hash is found that meets the leading 0's proof of
    # work requirement.
  ...
  def adjust_difficulty(last_block, new_timestamp):
    ...
    # Increase the diffifulty for quickly mined blocks.
  ...
  def is_valid_block(last_block, block):
    # Validate a block by enforcing these rules:
